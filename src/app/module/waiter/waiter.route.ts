...
router.get("/", checkAuth(...SETTINGS_ROLES), validateRequest(listWaiterQuerySchema, "query"), WaiterController.listWaiters);
router.get("/all", checkAuth(...SETTINGS_ROLES), WaiterController.getAllWaiters);
router.get("/:id", checkAuth(...SETTINGS_ROLES), validateRequest(waiterIdZodSchema, "params"), WaiterController.getWaiterById);
